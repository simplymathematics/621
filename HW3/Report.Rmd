...
Using variance inflation factors (VIF), we can test our model for multicollinearity. The `rad` and `tax` variables show high multicollinearity. Both variables should not be used together in our model as the standard error for both exceeds 2 times the amount then if these variables were not related. 
